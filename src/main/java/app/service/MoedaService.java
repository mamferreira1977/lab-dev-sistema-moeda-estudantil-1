...
public class MoedaService {
    ...
    public Resgate resgatarVantagem(Long alunoId, Long vantagemId) {
        ...
        String codigoVerificacao = "MOEDA-" + UUID.randomUUID().toString().toUpperCase();
        String conteudoQr = "Sistema de Moeda Estudantil|Cupom=" + codigo
                + "|Verificacao=" + codigoVerificacao
                + "|Aluno=" + aluno.getId()
                + "|Vantagem=" + vantagem.getId();
        String qrCodeBase64 = qrCodeService.gerarQrCodeBase64(conteudoQr);
        ...
        resgate.setCodigoVerificacao(codigoVerificacao);
        resgate.setQrCodeBase64(qrCodeBase64);
        ...
        String mensagemAluno = "Cupom gerado para a vantagem '" + vantagem.getTitulo() + "'."
                + "\nCódigo do cupom: " + codigo
                + "\nCódigo de verificação: " + codigoVerificacao
                + "\nCusto: " + vantagem.getCustoMoedas() + " moeda(s)"
                + "\nSaldo disponível após o resgate: " + aluno.getSaldoMoedas() + " moeda(s)."
                + "\nApresente este QR Code e o código do cupom no estabelecimento parceiro."
                + "\nQR_CODE_BASE64:" + qrCodeBase64;
        String mensagemEmpresa = "O aluno " + aluno.getNome() + " resgatou a vantagem '" + vantagem.getTitulo() + "'."
                + "\nCódigo do cupom: " + codigo
                + "\nCódigo de verificação: " + codigoVerificacao
                + "\nCusto: " + vantagem.getCustoMoedas() + " moeda(s)"
                + "\nConfira o QR Code apresentado presencialmente pelo aluno."
                + "\nQR_CODE_BASE64:" + qrCodeBase64;
